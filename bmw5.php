...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">BMW 5 Series</p>
            <p class="smalltext">
                BMW 5 Series price starts at Rs. 5000 per day and goes upto Rs. 5,500 per day .
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://images.lifestyleasia.com/wp-content/uploads/sites/7/2022/05/19154247/2023-BMW-3-Series-white.jpg" alt="BMW 5 Series">
        </div>
    </section>
