...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">12 Seater Economy class</p>
            <p class="smalltext">
                12 Seater Economy class price starts at Rs. 25 per km and Rs. 500 per day for driver.
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://4.imimg.com/data4/YY/YY/GLADMIN-/img-tempo1-500x500.jpg" alt="12 seater">
        </div>
    </section>
