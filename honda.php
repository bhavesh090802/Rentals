...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">Honda Jazz 1.5</p>
            <p class="smalltext">
            Skoda Octavia price starts at Rs. 500 per day and goes upto Rs. 600 per day .
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://5.imimg.com/data5/NK/MA/MY-11082818/honda-jazz-1-5-vx-i-dtec-car-500x500.png" alt="Jazz">
        </div>
    </section>
