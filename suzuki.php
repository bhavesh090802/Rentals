...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">Suzuki Ignis K12D</p>
            <p class="smalltext">
            Suzuki Ignis K12D price starts at Rs. 800 per day and goes upto Rs. 850 per day .
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://media.suzuki.co.uk/assets/images/hero/5174-IGNIS01.jpg" alt="Suzuki">
        </div>
