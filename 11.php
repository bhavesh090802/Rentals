...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">11 Seater Economy class</p>
            <p class="smalltext">
                11 Seater Economy class price starts at Rs. 23 per km and Rs. 500 per day for driver.
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://www.onlinebusbookingindia.com/uploads/40987_Mercedes-Sprinter-interior-1-low-res.jpg" alt="11 seater">
        </div>
    </section>
