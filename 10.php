...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">10 Seater Economy class</p>
            <p class="smalltext">
                10 Seater Economy class price starts at  Rs. 23 per km and Rs. 500 per day for driver.
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="http://www.busorvanbooking.com/images/commuter-3.jpg" alt="10 seater">
        </div>
    </section>
