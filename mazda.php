...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">Mazda 2 1.5</p>
            <p class="smalltext">
            Mazda 2 1.5 price starts at Rs. 500 per day and goes upto Rs. 600 per day .
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://car-images.bauersecure.com/wp-images/14134/mazda2_01.jpg" alt="Mazda">
        </div>
    </section>
