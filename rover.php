...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">Land Rover</p>
            <p class="smalltext">
            Land Rover price starts at Rs. 1000 per day and goes upto Rs. 1,200 per day .
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://media.jlrms.com/2020-11/New_Discovery_V2.jpg?VersionId=oj71Byxt.PsZ.gCJiDf84TOVijDr.pYq" alt="Land Rover">
        </div>
    </section>
