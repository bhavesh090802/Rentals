...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">34 Seater Economy class</p>
            <p class="smalltext">
                34 Seater Economy class price starts at Rs. 42 per km and Rs. 500 per day for driver.
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://beelinetours.com/wp-content/uploads/2018/08/IMG_5211.jpg" alt="34 seater">
        </div>
    </section>
