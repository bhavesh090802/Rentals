...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">Skoda Octavia</p>
            <p class="smalltext">
            Skoda Octavia price starts at Rs. 4,500 per day and goes upto Rs. 5,000 per day .
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://cdn.motor1.com/images/mgl/1xB1K/s3/2021-skoda-octavia-rs.jpg" alt="Octavia">
        </div>
    </section>
