...
<body>
    ...
    <section class="Section ">
        <div class="firsthalf">
            <p id="vehicle">Jeep Compass</p>
            <p class="smalltext">
                Jeep Compass price starts at Rs. 1200 per day and goes upto Rs. 1,300 per day .
                <br><br>
                <a href="book.php">Click Here For Booking.</a>
            </p>
        </div>
        <div class="secondhalf">
            <img src="https://cdn.jdpower.com/JDPA_2020%20Jeep%20Compass%20Limited%20Red%20Front%20View.jpg" alt="Jeep">
        </div>
    </section>
